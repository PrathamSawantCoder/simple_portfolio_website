  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <nav className='container mx-auto px-6 flex items-center justify-between'>
            <a href="/" className='text-xl font-bold tracking-tight hover:text-primary transition-colors duration-300 flex items-center gap-2'>
            ...
            <div className='hidden md:block items-center gap-1'>
                <Button size="sm" className="hover-lift" onClick={() => handleScroll('#contact')}>Contact Me</Button>
            </div>
        ...
        {isMenuOpen && (
            <div className="md:hidden glass-strong animate-fade-in">
                <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
                    ...
                    <Button className="mt-4 w-full hover-lift">Contact Me</Button>
                </div>
            </div>
        )}
    </header>
